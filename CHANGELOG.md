...
- **Integrasi SSO (homelab-idp)**: Menambahkan Forward Auth proxy bypass untuk qBittorrent, dll, native OIDC pada Komga, dan script setup OCC OIDC untuk Nextcloud.
