...
- [Claude Code] 2026-09-22: Adding GPU (/dev/dri) passthrough to LXC 104 (media-hosts) for jellyfin hw transcoding | Locks: pve /etc/pve/lxc/104.conf, LXC 104 reboot
